describe('Generate data from 2i tool', () => {
    it('Generate random user data', function() {
    ...
    it('Parse CSV file into JSON file', function() {
...
describe('Load data', () => {
    ...
    it('load users data', () => {
        ...
        // Visit the page
        cy.visit('http://webdev.edinburghcollege.ac.uk/~HNDSOFTSA24/Industry-Led/index.html')

        users.forEach(user => {

            // Type in data from JSON file into HTML form
